 ...
 * in the Stage (App) so a human tap, the Settings app, the scenario player,
 * and the assistant's plan executor all drive it the same way. The assistant is mounted
